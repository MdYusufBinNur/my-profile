        ...
        <div class="footer-grid" style="margin-bottom: 20px">
          <div class="pt-12">
            ...
            <div class="d-flex flex-wrap align-items-center mt-10">
              <span class="text-xl fw-bold font-Syne text-white">Information</span>
              <div class="footer-social">
                <ul class="d-flex flex-wrap gap-x-4 align-items-center list-unstyled p-0 footer-social-links">
                  <li><a href="https://www.linkedin.com/in/yusuf-bin-nur-506402162/" target="_blank" class="text-white footer-social-link">
                  ...
                  <li><a href="https://github.com/MdYusufBinNur" target="_blank" class="text-white footer-social-link">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                         xmlns="http://www.w3.org/2000/svg">
