    ...
    <div class="container mx-auto">
      <div class="row mb-n6">
        ...
        <div class="col-12 col-lg-6 mb-6" data-aos="fade-up" data-aos-delay="300">
          <form id="contact-form" @submit.prevent="handleSubmit" method="post" class="row">
            <div class="col-12 col-md-6">
              <label class="text-sm fw-normal font-Inter leading-tight mb-3 d-block" for="name">Name</label>
              <input v-model="name" id="name" class="fw-normal w-full leading-7 contact-form-control " type="text"
            ...
            <div class="col-12 col-md-6">
              ...
              <input v-model="email" id="Email" class="fw-normal w-full leading-7 contact-form-control " type="email"
                     placeholder="Your email*" name="email" required>
            </div>
            <div class="col-12 col-md-6">
              <label class="text-sm fw-normal font-Inter leading-tight mb-3 d-block" for="Phone">Phone</label>
              <input v-model="phone" id="Phone" class="fw-normal w-full leading-7 contact-form-control " type="text"
                     placeholder="Your number" name="phone" required>
            </div>
            <div class="col-12 col-md-6">
              <label class="text-sm fw-normal font-Inter leading-tight mb-3 d-block" for="Subject">Subject*</label>
              <input v-model="subject" id="Subject" class="fw-normal w-full leading-7 contact-form-control " type="text"
            ...
            <div class="col-12">
              ...
              <textarea v-model="message" class="fw-normal w-full contact-form-control resize-none" name="message"
              ...
              <div
                ...
                <div class="d-flex flex-wrap gap-23">
                  ...
                  <ul class="d-flex flex-wrap gap-x-4 align-items-center p-0 list-unstyled">
                    <li><a href="https://www.linkedin.com/in/yusuf-bin-nur-506402162/" class="contact-social-link">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                    ...
                    <li><a href="https://github.com/MdYusufBinNur" class="contact-social-link">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
