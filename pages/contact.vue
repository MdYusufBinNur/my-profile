    ...
    <div class="container mx-auto">
      <div class="row mb-n6">
          ...
          <div class="d-flex flex-wrap flex-column gap-7">
            <div class="d-flex flex-wrap address-item">
              ...
              <div class="d-flex flex-wrap flex-column flex-1">
                <span class="paragraph leading-none">Email me</span>
                <h5 class="text-xl fw-bold font-Syne text-dark leading-7">mdyusufbinnur@gmail.com
                </h5>
              </div>
            </div>
            <div class="d-flex flex-wrap address-item">
              ...
              <div class="d-flex flex-wrap flex-column flex-1">
                ...
                <h5 class="text-xl fw-bold font-Syne text-dark leading-7">
                  +880 1815 625 375
                </h5>
              </div>
            </div>
        ...
        <div class="col-12 col-lg-6 mb-6" data-aos="fade-up" data-aos-delay="300">
          <form id="contact-form" action="mail.php.html" method="post" class="row">
            <div class="col-12 col-md-6">
              <label class="text-sm fw-normal font-Inter leading-tight mb-3 d-block" for="name">Name</label>
              <input id="name" class="fw-normal w-full leading-7 contact-form-control " type="text" placeholder="Your name*" name="name">
            </div>
            <div class="col-12 col-md-6">
              <label class="text-sm fw-normal font-Inter leading-tight mb-3 d-block" for="Email">Email</label>
              <input id="Email" class="fw-normal w-full leading-7 contact-form-control " type="email" placeholder="Your email*" name="email">
            </div>
            <div class="col-12 col-md-6">
              <label class="text-sm fw-normal font-Inter leading-tight mb-3 d-block" for="Phone">Phone</label>
              <input id="Phone" class="fw-normal w-full leading-7 contact-form-control " type="text" placeholder="Your number" name="phone">
            </div>
            <div class="col-12 col-md-6">
              <label class="text-sm fw-normal font-Inter leading-tight mb-3 d-block" for="Subject">Subject*</label>
              <input id="Subject" class="fw-normal w-full leading-7 contact-form-control " type="text" placeholder="Your subject*" name="subject">
            </div>

            <div class="col-12">
              <label class="text-sm fw-normal font-Inter leading-tight mb-3 d-block" for="Message">Message</label>
              <textarea class="fw-normal w-full contact-form-control resize-none" name="message" id="Message" cols="30" rows="10" placeholder="Type your message"></textarea>
            </div>
        ...
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M7 7H17V17" stroke="currentColor" stroke-opacity="0.9" stroke-width="2" stroke-linecap="round"
            ...
            <div class="col-12">
              <div class="justify-constnt-start align-items-sm-center gap-23 d-inline-flex mt-14 flex-column flex-sm-row">
                ...
                <div class="d-flex flex-wrap gap-23">
                  ...
                  <ul class="d-flex flex-wrap gap-x-4 align-items-center p-0 list-unstyled">
                    <li><a href="https://www.linkedin.com/in/yusuf-bin-nur-506402162/" class="contact-social-link"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li><a href="https://github.com/MdYusufBinNur" class="contact-social-link"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
